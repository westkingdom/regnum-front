...
try:
    ...
    flow = Flow.from_client_secrets_file(
        ...
        redirect_uri=os.environ.get('REDIRECT_URI', 'redirect_uri=https://regnum-front-85382560394.us-west1.run.app%20flowName=GeneralOAuthFlow ') # Use env var or default
    )
